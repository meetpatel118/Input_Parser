...
#input_file='D:\input_parser\input_file.txt'
#standard_def_file = 'D:\input_parser\standard_definition.json'
#error_code_file = 'D:\input_parser\error_codes.json'
...
def getStandardDef(standard_def_file):      #To get the Definition information from file
    ...
    try:
        if not os.path.exists(standard_def_file):
            log_error('File '+ standard_def_file +' does not exist!')
